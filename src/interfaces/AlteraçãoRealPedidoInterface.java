...
public class AlteraçãoRealPedidoInterface {
    ...
    private JPanel gerarCorpoPanel() {
    	...
    	PanelTField situacaoPanel = gerarComponente("Situação Pedido");
    ...
    private JPanel gerarRodapePanel() {
    	...
    	menuButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	AlteraçãoRealPedidoInterface.this.setVisible(false);
    	...
    	alterarButton.addActionListener(new ActionListener() {
    	    public void actionPerformed(ActionEvent e) {
				if(getPedido()!=null) {
					...
					pedido.setSituacao(getSituacaoField().getText());  
    ...
    public AlteraçãoRealPedidoInterface(BancoPedidos bancoPedidos, Pedido pedido) {
